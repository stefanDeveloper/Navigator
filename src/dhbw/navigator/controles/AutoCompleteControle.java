...
public class AutoCompleteControle extends GridPane {
	...
	private TextFieldAutoCompleteControle textField; // TextField with
														// AutoComplete
	private PropertyChangeSupport changes = new PropertyChangeSupport(this);
	private String text; // Input-Text //TODO ?????
	...
	public AutoCompleteControle(String labelText) {
		...
		clearButton.setOnAction(event -> AutoCompleteControle.this.textField.setText(""));
		// Listen to the input
